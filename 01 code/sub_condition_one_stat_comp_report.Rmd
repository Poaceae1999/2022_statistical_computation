...
# gogogo
```{r}
b_tau <- 1# i don't know

a <- 1
Cmax <- Cauchy_plus(10^-8,b_tau)
dat <- collected_data_from(accept_reject_K_invG,times=1000,a = a,b = 1,K = Cmax,fx=Cauchy_plus,b_cauchy=b_tau)
draw(Cauchy_plus,dat,b_cauchy=b_tau)
```
